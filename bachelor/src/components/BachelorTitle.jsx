                ...
                <div className={styles.row}>
                    <div className={styles.aboutCard}>
                        ...
                        <div className={styles.cardContext}>
                            ...
                            <h4>Company</h4>
                            <p className='text-main'>The project team undertook a master's thesis-level project and delivered admirable results. The software they developed is currently being expanded upon and utilized internally.</p>
                        </div>
                    </div>
                    <div className={styles.aboutCard}>
                        ...
                        <div className={styles.cardContext}>
                            ...
                            <h4>Supervisors</h4>
                            <p className='text-main'>As supervisors, we strive to guide the students in the right direction and to be able to answer all their questions. However, this project addressed a topic outside the school curriculum, yet the project team managed to deliver results that exceeded our expectations. We were excited to see the end result, and it did not disappoint.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.row}>
                    <div className={styles.aboutCard}>
                        ...
                        <div className={styles.cardContext}>
                            ...
                            <p className='text-main'>The project provided an opportunity for personal growth particularly in terms of research skills and technical knowledge such as working with GPUs. The process of trying out
                    ...
                    <div className={styles.aboutCard}>
                        ...
                        <h3>Mark</h3> <h4>Team Member</h4>
                            <p className='text-main'>I am certain that this project has fortified all of our technical skills and gathered valuable lessons in resilience, collaboration, and problem-solving, lessons that will be
